...
```bash
# macOS / Linux
curl -fsSL https://github.com/weijunjiang123/skill-repo/releases/download/v0.2.0/install-binary.sh | SKILL_REPO_VERSION=v0.2.0 sh
```

```powershell
# Windows PowerShell
$env:SKILL_REPO_VERSION="v0.2.0"; irm https://github.com/weijunjiang123/skill-repo/releases/download/v0.2.0/install-binary.ps1 | iex
```
